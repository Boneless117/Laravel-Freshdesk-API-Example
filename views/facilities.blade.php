...
@section('content')
    ...
    <div class="panel-header mb-0 ">
        <div class="header text-center">
            <h1 class="display-4 text-center text-white mb-0">Facilities : Service Request</h1>
        </div>
    </div>
            ...
            <div class="card-body p-t-0">
                <div class="" id="submit" role="tabpanel" aria-labelledby="submit-tab">
                    ...
                    <div class="alert alert-primary text-center" role="alert">
                        Please submit a support request for <strong>each job</strong> required.<br>Do not submit more
                        than one job in this request.
                    </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                ...
                                <div class="input-group date" id="">
                                    <div class="input-group">
                                        <input name="date" type="text" class="form-control " id="datetimepicker" autocomplete="off"
                                               required>
                                    </div>
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input name="subject" type="text" class="form-control" id="subject-input"
                                       ...
                                       placeholder="Example: Air con not working"
                                       autocomplete="off"
                                       pattern=".{4,30}"
...
<!--[if IE]>
    ...
    <script>
        ...
        // Reset the date and time to nothing...
        $("#datetimepicker").val("");
        ...
        $("#ticket-form").on('submit', function (e) {
            ...
            if (sendEmail === true) {
                ...
                $.ajax({
                    type: 'post',
                    url: "{{url('')}}/api/v1_0/portal/service/create/facilities",
                    data: formData,
                    beforeSend: function () {
                    ...
                    success: function (response) {
                        ...
                        success_msg_again(response['msg']);
